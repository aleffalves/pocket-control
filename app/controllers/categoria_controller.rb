class CategoriaController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @categorium.save
        format.html { redirect_to @categorium, notice: "Categorium foi criada com sucesso." }
  ...
  def update
    respond_to do |format|
      if @categorium.update(categorium_params)
        format.html { redirect_to @categorium, notice: "Categorium foi atualizada com sucesso." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to categoria_path, status: :see_other, notice: "Categorium foi deletada com sucesso." }
