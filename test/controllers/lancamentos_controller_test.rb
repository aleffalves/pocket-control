...
class LancamentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lancamento" do
    assert_difference("Lancamento.count") do
      post lancamentos_url, params: { lancamento: { categoria_id: @lancamento.categoria_id, consumidor_id: @lancamento.consumidor_id, data: @lancamento.data, valor: @lancamento.valor } }
    end
  ...
  test "should update lancamento" do
    patch lancamento_url(@lancamento), params: { lancamento: { categoria_id: @lancamento.categoria_id, consumidor_id: @lancamento.consumidor_id, data: @lancamento.data, valor: @lancamento.valor } }
